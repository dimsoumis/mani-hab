...
$user = $_SESSION['userEmail'];  
 ...
 $sql1 = "select * from write_the_letter where user = '$user' ORDER BY reg_date DESC";  
...
$sqlStats1 = "select * from write_the_letter where user = '$user' and level = 'Level 1'";  
...
$sqlStats2 = "select * from write_the_letter where user = '$user' and level = 'Level 2'";  
...
$sqlStats3 = "select * from write_the_letter where user = '$user' and level = 'Level 3'";  
...
$sqlStats4 = "select * from write_the_letter where user = '$user' and level = 'Level 4'";  
...
$sqlStats5 = "select * from write_the_letter where user = '$user' and level = 'Level 5'";  
...
<p style="text-align: center;">Check the previous scores you have achieved (lower scores are better).</p>
	...
	for ($x = 1; $x <= $noOfPages; $x++) {
		...
		$sqlLoop = "select * from write_the_letter where user = '$user' ORDER BY reg_date DESC LIMIT 20 OFFSET $x2";  
