...
<p style="text-align: center;">Choose the level you want to exercise at, see instructions about how to perform the exercise or see previous scores.</p>
	...
	<div class="row" style="justify-content: space-around;">
		<div class="column3">
			<img id="level1img" style="width: 200px;" src="/images/numbers-sortage.png" />
			<h3 id="level1txt" style="text-align: center;">Level 1</h3>
	</div>
		<div class="column3">
			<img id="level2img" style="width: 200px;" src="/images/numbers-sortage.png" />
				<h3 id="level2txt" style="text-align: center;">Level 2</h3>
	</div>
				<div class="column3">
			<img id="level3img" style="width: 200px;" src="/images/numbers-sortage.png" />
