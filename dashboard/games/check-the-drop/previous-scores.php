...
$user = $_SESSION['userEmail'];  
 ...
 $sql1 = "select * from check_the_drop where user = '$user' ORDER BY reg_date DESC";  
...
$sqlStats = "select * from check_the_drop where user = '$user'";  
...
<p style="text-align: center;">Check the previous scores you have achieved (higher scores are better).</p>
	...
	for ($x = 1; $x <= $noOfPages; $x++) {
		...
		$sqlLoop = "select * from check_the_drop where user = '$user' ORDER BY reg_date DESC LIMIT 20 OFFSET $x2";  
