...
This repository contains a web-based platform designed to help users perform guided exercises for fine motor skills, complete assessment tests, and monitor their progress over time.
...
- Fine motor skills assessment systems
- Research projects
...
Users can perform structured exercise routines focusing on fine motor skills, through an interactive web interface.
