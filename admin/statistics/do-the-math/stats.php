...
$sqlForPatientsStatsLevel1 = "SELECT * FROM do_the_math WHERE level='Level 1' AND user IN (SELECT email FROM users WHERE status = 'patient')";
...
$countForPatientsStatsLevel1 = mysqli_num_rows($resultForPatientsStatsLevel1);
 ...
 $sqlForStatsLevel2 = "select * from do_the_math WHERE level='Level 2'";  
        $resultForStatsLevel2 = mysqli_query($con, $sqlForStatsLevel2);  
        $countForStatsLevel2 = mysqli_num_rows($resultForStatsLevel2);

$sqlForHealthyStatsLevel2 = "SELECT * FROM do_the_math WHERE level='Level 2' AND user IN (SELECT email FROM users WHERE status = 'healthy')";
...
$sqlForPatientsStatsLevel2 = "SELECT * FROM do_the_math WHERE level='Level 2' AND user IN (SELECT email FROM users WHERE status = 'patient')";
...
$countForPatientsStatsLevel2 = mysqli_num_rows($resultForPatientsStatsLevel2);
 ...
 $sqlForStatsLevel3 = "select * from do_the_math WHERE level='Level 3'";  
        $resultForStatsLevel3 = mysqli_query($con, $sqlForStatsLevel3);  
        $countForStatsLevel3 = mysqli_num_rows($resultForStatsLevel3);

$sqlForHealthyStatsLevel3 = "SELECT * FROM do_the_math WHERE level='Level 3' AND user IN (SELECT email FROM users WHERE status = 'healthy')";
...
$sqlForPatientsStatsLevel3 = "SELECT * FROM do_the_math WHERE level='Level 3' AND user IN (SELECT email FROM users WHERE status = 'patient')";
