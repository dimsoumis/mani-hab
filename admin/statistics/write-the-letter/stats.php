...
$dbname = "mani_hab_space";
 ...
 $sql = "select * from write_the_letter";  
 ...
 $sqlForStats = "select * from write_the_letter";  
        $resultForStats = mysqli_query($con, $sqlForStats);  
        $countForStats = mysqli_num_rows($resultForStats);


$sqlForHealthyStats = "SELECT * FROM write_the_letter WHERE user IN (SELECT email FROM users WHERE status = 'healthy')";
$resultForHealthyStats = mysqli_query($con, $sqlForHealthyStats);  
$countForHealthyStats = mysqli_num_rows($resultForHealthyStats);

$sqlForPatientsStats = "SELECT * FROM write_the_letter WHERE user IN (SELECT email FROM users WHERE status = 'patient')";
$resultForPatientsStats = mysqli_query($con, $sqlForPatientsStats);  
$countForPatientsStats = mysqli_num_rows($resultForPatientsStats);


 $sqlForStatsLevel1 = "select * from write_the_letter WHERE level='Level 1'";  
        $resultForStatsLevel1 = mysqli_query($con, $sqlForStatsLevel1);  
        $countForStatsLevel1 = mysqli_num_rows($resultForStatsLevel1);

$sqlForHealthyStatsLevel1 = "SELECT * FROM write_the_letter WHERE level='Level 1' AND user IN (SELECT email FROM users WHERE status = 'healthy')";
...
$sqlForPatientsStatsLevel1 = "SELECT * FROM write_the_letter WHERE level='Level 1' AND user IN (SELECT email FROM users WHERE status = 'patient')";
...
$countForPatientsStatsLevel1 = mysqli_num_rows($resultForPatientsStatsLevel1);
 ...
 $sqlForStatsLevel2 = "select * from write_the_letter WHERE level='Level 2'";  
        $resultForStatsLevel2 = mysqli_query($con, $sqlForStatsLevel2);  
        $countForStatsLevel2 = mysqli_num_rows($resultForStatsLevel2);

$sqlForHealthyStatsLevel2 = "SELECT * FROM write_the_letter WHERE level='Level 2' AND user IN (SELECT email FROM users WHERE status = 'healthy')";
...
$sqlForPatientsStatsLevel2 = "SELECT * FROM write_the_letter WHERE level='Level 2' AND user IN (SELECT email FROM users WHERE status = 'patient')";
...
$countForPatientsStatsLevel2 = mysqli_num_rows($resultForPatientsStatsLevel2);
 ...
 $sqlForStatsLevel3 = "select * from write_the_letter WHERE level='Level 3'";  
        $resultForStatsLevel3 = mysqli_query($con, $sqlForStatsLevel3);  
        $countForStatsLevel3 = mysqli_num_rows($resultForStatsLevel3);

$sqlForHealthyStatsLevel3 = "SELECT * FROM write_the_letter WHERE level='Level 3' AND user IN (SELECT email FROM users WHERE status = 'healthy')";
...
$sqlForPatientsStatsLevel3 = "SELECT * FROM write_the_letter WHERE level='Level 3' AND user IN (SELECT email FROM users WHERE status = 'patient')";
...
$countForPatientsStatsLevel3 = mysqli_num_rows($resultForPatientsStatsLevel3);
 ...
 $sqlForStatsLevel4 = "select * from write_the_letter WHERE level='Level 4'";  
        $resultForStatsLevel4 = mysqli_query($con, $sqlForStatsLevel4);  
        $countForStatsLevel4 = mysqli_num_rows($resultForStatsLevel4);

$sqlForHealthyStatsLevel4 = "SELECT * FROM write_the_letter WHERE level='Level 4' AND user IN (SELECT email FROM users WHERE status = 'healthy')";
...
$sqlForPatientsStatsLevel4 = "SELECT * FROM write_the_letter WHERE level='Level 4' AND user IN (SELECT email FROM users WHERE status = 'patient')";
...
$countForPatientsStatsLevel4 = mysqli_num_rows($resultForPatientsStatsLevel4);
 ...
 $sqlForStatsLevel5 = "select * from write_the_letter WHERE level='Level 5'";  
        $resultForStatsLevel5 = mysqli_query($con, $sqlForStatsLevel5);  
        $countForStatsLevel5 = mysqli_num_rows($resultForStatsLevel5);

$sqlForHealthyStatsLevel5 = "SELECT * FROM write_the_letter WHERE level='Level 5' AND user IN (SELECT email FROM users WHERE status = 'healthy')";
$resultForHealthyStatsLevel5 = mysqli_query($con, $sqlForHealthyStatsLevel5);  
$countForHealthyStatsLevel5 = mysqli_num_rows($resultForHealthyStatsLevel5);

$sqlForPatientsStatsLevel5 = "SELECT * FROM write_the_letter WHERE level='Level 5' AND user IN (SELECT email FROM users WHERE status = 'patient')";
$resultForPatientsStatsLevel5 = mysqli_query($con, $sqlForPatientsStatsLevel5);  
$countForPatientsStatsLevel5 = mysqli_num_rows($resultForPatientsStatsLevel5);
...
$maxScoreRight1Level5 = 0;
	$maxScoreLeft1Level5 = 0;
	$minScoreRight1Level5 = 5000;
	$minScoreLeft1Level5 = 5000;
	$averageScoreRight1Level5 = 0;
	$averageScoreLeft1Level5 = 0;
$rightScoresCounter1Level5 = 0;
$leftScoresCounter1Level5 = 0;

		while($row = mysqli_fetch_array($resultForStatsLevel5)) {
		
			$actualScoreLevel5 = $row['score'];
			$actualHandLevel5 = $row['hand'];
			
		
			if ($actualHandLevel5 == "Right") {
				if ($actualScoreLevel5 > $maxScoreRight1Level5) {
					$maxScoreRight1Level5 = $actualScoreLevel5;
				}
				
				$averageScoreRight1Level5 = $averageScoreRight1Level5 + $actualScoreLevel5;
				$rightScoresCounter1Level5++;
				
			} else {
			if ($actualScoreLevel5 > $maxScoreLeft1Level5) {
					$maxScoreLeft1Level5 = $actualScoreLevel5;
				}	
				
				$averageScoreLeft1Level5 = $averageScoreLeft1Level5 + $actualScoreLevel5;
				$leftScoresCounter1Level5++;
					
			}
		
		
			if ($actualHandLevel5 == "Right") {
				if ($actualScoreLevel5 < $minScoreRight1Level5) {
					$minScoreRight1Level5 = $actualScoreLevel5;
				}
			} else {
			if ($actualScoreLevel5 < $minScoreLeft1Level5) {
					$minScoreLeft1Level5 = $actualScoreLevel5;
				}	
			} 
			...
			$averageScoreRight1Level5 = $averageScoreRight1Level5 / $rightScoresCounter1Level5;
				$averageScoreLeft1Level5 = $averageScoreLeft1Level5 / $leftScoresCounter1Level5;
			
if ($minScoreRight1Level5 == 5000) {
	$minScoreRight1Level5 = 0;
}
	if ($minScoreLeft1Level5 == 5000) {
	$minScoreLeft1Level5 = 0;
}
	...
	$maxScoreRightHealthyLevel5 = 0;
	$maxScoreLeftHealthyLevel5 = 0;
	$minScoreRightHealthyLevel5 = 5000;
	$minScoreLeftHealthyLevel5 = 5000;
	$averageScoreRightHealthyLevel5 = 0;
	$averageScoreLeftHealthyLevel5 = 0;
$rightScoresCounterHealthyLevel5 = 0;
$leftScoresCounterHealthyLevel5 = 0;
	
		while($row = mysqli_fetch_array($resultForHealthyStatsLevel5)) {
		
			$actualScoreHealthyLevel5 = $row['score'];
			$actualHandHealthyLevel5 = $row['hand'];
			
			
			if ($actualHandHealthyLevel5 == "Right") {
				if ($actualScoreHealthyLevel5 > $maxScoreRightHealthyLevel5) {
					$maxScoreRightHealthyLevel5 = $actualScoreHealthyLevel5;
				}
				
				$averageScoreRightHealthyLevel5 = $averageScoreRightHealthyLevel5 + $actualScoreHealthyLevel5;
				$rightScoresCounterHealthyLevel5++;
				
			} else {
			if ($actualScoreHealthyLevel5 > $maxScoreLeftHealthyLevel5) {
					$maxScoreLeftHealthyLevel5 = $actualScoreHealthyLevel5;
				}	
				
				$averageScoreLeftHealthyLevel5 = $averageScoreLeftHealthyLevel5 + $actualScoreHealthyLevel5;
				$leftScoresCounterHealthyLevel5++;
					
			}
		
		
			if ($actualHandHealthyLevel5 == "Right") {
				if ($actualScoreHealthyLevel5 < $minScoreRightHealthyLevel5) {
					$minScoreRightHealthyLevel5 = $actualScoreHealthyLevel5;
				}
			} else {
			if ($actualScoreHealthyLevel5 < $minScoreLeftHealthyLevel5) {
					$minScoreLeftHealthyLevel5 = $actualScoreHealthyLevel5;
				}	
			}
			...
			$averageScoreRightHealthyLevel5 = $averageScoreRightHealthyLevel5 / $rightScoresCounterHealthyLevel5;
				$averageScoreLeftHealthyLevel5 = $averageScoreLeftHealthyLevel5 / $leftScoresCounterHealthyLevel5;
			
if ($minScoreRightHealthyLevel5 == 5000) {
	$minScoreRightHealthyLevel5 = 0;
}
	if ($minScoreLeftHealthyLevel5 == 5000) {
	$minScoreLeftHealthyLevel5 = 0;
}
...
$maxScoreRightPatientsLevel5 = 0;
	$maxScoreLeftPatientsLevel5 = 0;
	$minScoreRightPatientsLevel5 = 5000;
	$minScoreLeftPatientsLevel5 = 5000;
	$averageScoreRightPatientsLevel5 = 0;
	$averageScoreLeftPatientsLevel5 = 0;
$rightScoresCounterPatientsLevel5 = 0;
$leftScoresCounterPatientsLevel5 = 0;
	
		while($row = mysqli_fetch_array($resultForPatientsStatsLevel5)) {
		
			$actualScorePatientsLevel5 = $row['score'];
			$actualHandPatientsLevel5 = $row['hand'];
			
			
			if ($actualHandPatientsLevel5 == "Right") {
				if ($actualScorePatientsLevel5 > $maxScoreRightPatientsLevel5) {
					$maxScoreRightPatientsLevel5 = $actualScorePatientsLevel5;
				}
				
				$averageScoreRightPatientsLevel5 = $averageScoreRightPatientsLevel5 + $actualScorePatientsLevel5;
				$rightScoresCounterPatientsLevel5++;
				
			} else {
			if ($actualScorePatientsLevel5 > $maxScoreLeftPatientsLevel5) {
					$maxScoreLeftPatientsLevel5 = $actualScorePatientsLevel5;
				}	
				
				$averageScoreLeftPatientsLevel5 = $averageScoreLeftPatientsLevel5 + $actualScorePatientsLevel5;
				$leftScoresCounterPatientsLevel5++;
					
			}
		
		
			if ($actualHandPatientsLevel5 == "Right") {
				if ($actualScorePatientsLevel5 < $minScoreRightPatientsLevel5) {
					$minScoreRightPatientsLevel5 = $actualScorePatientsLevel5;
				}
			} else {
			if ($actualScorePatientsLevel5 < $minScoreLeftPatientsLevel5) {
					$minScoreLeftPatientsLevel5 = $actualScorePatientsLevel5;
				}	
			}
			...
			$averageScoreRightPatientsLevel5 = $averageScoreRightPatientsLevel5 / $rightScoresCounterPatientsLevel5;
				$averageScoreLeftPatientsLevel5 = $averageScoreLeftPatientsLevel5 / $leftScoresCounterPatientsLevel5;
			
if ($minScoreRightPatientsLevel5 == 5000) {
	$minScoreRightPatientsLevel5 = 0;
}
	if ($minScoreLeftPatientsLevel5 == 5000) {
	$minScoreLeftPatientsLevel5 = 0;
}
...
<?php include '../admin-head.php';?>
	...
	echo "</table>";
		...
		<th>Average Time (Left)</th>
			...
			echo $minScoreRight1Level5;
			
			echo "</td><td>";
			
			echo $minScoreLeft1Level5;
			
			echo "</td><td>";
			
			echo $maxScoreRight1Level5;
			
			echo "</td><td>";
			
			echo $maxScoreLeft1Level5;
			
			echo "</td><td>";
			
			echo $averageScoreRight1Level5;
			
			echo "</td><td>";
			
			echo $averageScoreLeft1Level5;
	...
	echo "</table>";
		...
		echo "<p style='text-align: center;'>There are no scores saved yet.</p>";		
				...
				?>
					...
					<h3 style="text-align: center;">Healthy (Level 5)</h3>
				
				<?php if($countForHealthyStatsLevel5 > 0) {
		echo "<table>
					<tr>
						<th>Quickest Time (Right)</th>
		<th>Quickest Time (Left)</th>
		...
		<th>Average Time (Left)</th>
			...
			echo $minScoreRightHealthyLevel5;
			
			echo "</td><td>";
			
			echo $minScoreLeftHealthyLevel5;
			
			echo "</td><td>";
			
			echo $maxScoreRightHealthyLevel5;
			
			echo "</td><td>";
			
			echo $maxScoreLeftHealthyLevel5;
			
			echo "</td><td>";
			
			echo $averageScoreRightHealthyLevel5;
			
			echo "</td><td>";
			
			echo $averageScoreLeftHealthyLevel5;
...
<h3 style="text-align: center;">Patients (Level 5)</h3>
				
				<?php if($countForPatientsStatsLevel5 > 0) {
		echo "<table>
					<tr>
						<th>Quickest Time (Right)</th>
		<th>Quickest Time (Left)</th>
		...
		<th>Average Time (Left)</th>
			...
			echo "<tr><td>";
				...
				echo $minScoreRightPatientsLevel5;
			
			echo "</td><td>";
			
	echo $minScoreLeftPatientsLevel5;		
			
			echo "</td><td>";
			
		echo $maxScoreRightPatientsLevel5;
			
			echo "</td><td>";
			
			echo $maxScoreLeftPatientsLevel5;
			
			echo "</td><td>";
			
			echo $averageScoreRightPatientsLevel5;
			
			echo "</td><td>";
			
			echo $averageScoreLeftPatientsLevel5;
