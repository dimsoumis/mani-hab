...
$dbname = "mani_hab_space";
 ...
 $sql = "select * from numbers_sortage";  
 ...
 $sqlForStats = "select * from numbers_sortage";  
        $resultForStats = mysqli_query($con, $sqlForStats);  
        $countForStats = mysqli_num_rows($resultForStats);


$sqlForHealthyStats = "SELECT * FROM numbers_sortage WHERE user IN (SELECT email FROM users WHERE status = 'healthy')";
$resultForHealthyStats = mysqli_query($con, $sqlForHealthyStats);  
$countForHealthyStats = mysqli_num_rows($resultForHealthyStats);

$sqlForPatientsStats = "SELECT * FROM numbers_sortage WHERE user IN (SELECT email FROM users WHERE status = 'patient')";
$resultForPatientsStats = mysqli_query($con, $sqlForPatientsStats);  
$countForPatientsStats = mysqli_num_rows($resultForPatientsStats);


 $sqlForStatsLevel1 = "select * from numbers_sortage WHERE level='Level 1'";  
        $resultForStatsLevel1 = mysqli_query($con, $sqlForStatsLevel1);  
        $countForStatsLevel1 = mysqli_num_rows($resultForStatsLevel1);

$sqlForHealthyStatsLevel1 = "SELECT * FROM numbers_sortage WHERE level='Level 1' AND user IN (SELECT email FROM users WHERE status = 'healthy')";
...
$sqlForPatientsStatsLevel1 = "SELECT * FROM numbers_sortage WHERE level='Level 1' AND user IN (SELECT email FROM users WHERE status = 'patient')";
...
$countForPatientsStatsLevel1 = mysqli_num_rows($resultForPatientsStatsLevel1);
 ...
 $sqlForStatsLevel2 = "select * from numbers_sortage WHERE level='Level 2'";  
        $resultForStatsLevel2 = mysqli_query($con, $sqlForStatsLevel2);  
        $countForStatsLevel2 = mysqli_num_rows($resultForStatsLevel2);

$sqlForHealthyStatsLevel2 = "SELECT * FROM numbers_sortage WHERE level='Level 2' AND user IN (SELECT email FROM users WHERE status = 'healthy')";
...
$sqlForPatientsStatsLevel2 = "SELECT * FROM numbers_sortage WHERE level='Level 2' AND user IN (SELECT email FROM users WHERE status = 'patient')";
...
$countForPatientsStatsLevel2 = mysqli_num_rows($resultForPatientsStatsLevel2);
 ...
 $sqlForStatsLevel3 = "select * from numbers_sortage WHERE level='Level 3'";  
        $resultForStatsLevel3 = mysqli_query($con, $sqlForStatsLevel3);  
        $countForStatsLevel3 = mysqli_num_rows($resultForStatsLevel3);

$sqlForHealthyStatsLevel3 = "SELECT * FROM numbers_sortage WHERE level='Level 3' AND user IN (SELECT email FROM users WHERE status = 'healthy')";
...
$sqlForPatientsStatsLevel3 = "SELECT * FROM numbers_sortage WHERE level='Level 3' AND user IN (SELECT email FROM users WHERE status = 'patient')";
