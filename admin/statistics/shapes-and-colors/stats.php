...
$countForPatientsStats = mysqli_num_rows($resultForPatientsStats);
 ...
 $sqlForStatsLevel1 = "select * from shapes_scores WHERE level='Level 1'";  
        $resultForStatsLevel1 = mysqli_query($con, $sqlForStatsLevel1);  
        $countForStatsLevel1 = mysqli_num_rows($resultForStatsLevel1);

$sqlForHealthyStatsLevel1 = "SELECT * FROM shapes_scores WHERE level='Level 1' AND user IN (SELECT email FROM users WHERE status = 'healthy')";
...
$sqlForPatientsStatsLevel1 = "SELECT * FROM shapes_scores WHERE level='Level 1' AND user IN (SELECT email FROM users WHERE status = 'patient')";
...
$countForPatientsStatsLevel1 = mysqli_num_rows($resultForPatientsStatsLevel1);
 ...
 $sqlForStatsLevel2 = "select * from shapes_scores WHERE level='Level 2'";  
        $resultForStatsLevel2 = mysqli_query($con, $sqlForStatsLevel2);  
        $countForStatsLevel2 = mysqli_num_rows($resultForStatsLevel2);

$sqlForHealthyStatsLevel2 = "SELECT * FROM shapes_scores WHERE level='Level 2' AND user IN (SELECT email FROM users WHERE status = 'healthy')";
...
$sqlForPatientsStatsLevel2 = "SELECT * FROM shapes_scores WHERE level='Level 2' AND user IN (SELECT email FROM users WHERE status = 'patient')";
...
$countForPatientsStatsLevel2 = mysqli_num_rows($resultForPatientsStatsLevel2);
 ...
 $sqlForStatsLevel3 = "select * from shapes_scores WHERE level='Level 3'";  
        $resultForStatsLevel3 = mysqli_query($con, $sqlForStatsLevel3);  
        $countForStatsLevel3 = mysqli_num_rows($resultForStatsLevel3);

$sqlForHealthyStatsLevel3 = "SELECT * FROM shapes_scores WHERE level='Level 3' AND user IN (SELECT email FROM users WHERE status = 'healthy')";
...
$sqlForPatientsStatsLevel3 = "SELECT * FROM shapes_scores WHERE level='Level 3' AND user IN (SELECT email FROM users WHERE status = 'patient')";
...
$countForPatientsStatsLevel3 = mysqli_num_rows($resultForPatientsStatsLevel3);
 ...
 $sqlForStatsLevel4 = "select * from shapes_scores WHERE level='Level 4'";  
        $resultForStatsLevel4 = mysqli_query($con, $sqlForStatsLevel4);  
        $countForStatsLevel4 = mysqli_num_rows($resultForStatsLevel4);

$sqlForHealthyStatsLevel4 = "SELECT * FROM shapes_scores WHERE level='Level 4' AND user IN (SELECT email FROM users WHERE status = 'healthy')";
...
$sqlForPatientsStatsLevel4 = "SELECT * FROM shapes_scores WHERE level='Level 4' AND user IN (SELECT email FROM users WHERE status = 'patient')";
...
$countForPatientsStatsLevel4 = mysqli_num_rows($resultForPatientsStatsLevel4);
 ...
 $sqlForStatsLevel5 = "select * from shapes_scores WHERE level='Level 5'";  
        $resultForStatsLevel5 = mysqli_query($con, $sqlForStatsLevel5);  
        $countForStatsLevel5 = mysqli_num_rows($resultForStatsLevel5);

$sqlForHealthyStatsLevel5 = "SELECT * FROM shapes_scores WHERE level='Level 5' AND user IN (SELECT email FROM users WHERE status = 'healthy')";
...
$sqlForPatientsStatsLevel5 = "SELECT * FROM shapes_scores WHERE level='Level 5' AND user IN (SELECT email FROM users WHERE status = 'patient')";
