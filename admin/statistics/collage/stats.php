...
$dbname = "mani_hab_space";
 ...
 $sqlForStats = "select * from collage";  
        $resultForStats = mysqli_query($con, $sqlForStats);  
        $countForStats = mysqli_num_rows($resultForStats);


$sqlForHealthyStats = "SELECT * FROM collage WHERE user IN (SELECT email FROM users WHERE status = 'healthy')";
$resultForHealthyStats = mysqli_query($con, $sqlForHealthyStats);  
$countForHealthyStats = mysqli_num_rows($resultForHealthyStats);

$sqlForPatientsStats = "SELECT * FROM collage WHERE user IN (SELECT email FROM users WHERE status = 'patient')";
